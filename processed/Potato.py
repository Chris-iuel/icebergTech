...
def load_data():
    # Read the data
    with open('C:\\Users\\Christopher\\Desktop\\icebergTECH\\processed\\train_cropped.json') as data_file:
...
def main():
    ...
    pred, keep1, keep2, W_fc1, W_fc2, W_fc3 = fully_connected(conv1_out, conv2_out, conv3_out, x_angle)
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(num_iter):
            ...
            for i in range(0, len(x_train_1), batch_size):
                ...
                if i % (2 * batch_size) == 0:
                    train_accuracy = accuracy.eval(feed_dict={x1: x_batch_1, x2: x_batch_2, x3: x_batch_3, x_angle: x_batch_4, y: y_batch, keep1: 1.0,keep2: 1.0})
            ...
            for i in (file_names):
                ...
                for j in range(0, len(x_train_1), batch_size):
                    ...
                    out = sess.run(softmax_pred,
                                   feed_dict={x1: x_batch_1, x2: x_batch_2, x3: x_batch_3, x_angle: x_batch_angle,
                                              keep1: 1.0, keep2: 1.0})
